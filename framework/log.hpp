...
#define put_msg(str) impl_put_msg(str)
    ...
    #define debug_color_msg(color_code,str,...) impl_debug_msg(color_code "%s : %s : %d : " str "\n" DEBUG_DEFAULT_COLOR, short_path(__FILE__), __FUNCTION__, __LINE__, ##__VA_ARGS__)
    ...
    #define debug_color_msg(color_code,str,...) impl_debug_msg(color_code "%s : %s : %d : " str "\n" DEBUG_DEFAULT_COLOR, short_path(__FILE__), __func__, __LINE__, ##__VA_ARGS__)
