//========================================================================================================================================================================================================================
// This header provides LibOVR error code declarations.
...
#define OVR_RESULT_DEFINED                              // Allows ovrResult to be independently defined. API call results are represented at the highest level by a single ovrResult.
...
{
    ovrSuccess = 0,                                     // This is a general success result. Use OVR_SUCCESS to test for success.
} ovrSuccessType;
#endif

//========================================================================================================================================================================================================================
// Public success types. Success is a value greater or equal to 0, while all error types are negative values.
//========================================================================================================================================================================================================================
