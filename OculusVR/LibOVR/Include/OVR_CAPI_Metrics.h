...
// ignore old functions. they may share the same name which will cause enumre definition problems
...
//  -callCountsFocus Filled with API call counts while app is in focus
//  -callCountsNoFocus Filled with API call count while app is out of focus
//  -maxLatencyNsFocus Filled with max latency while app is in focus
//  -maxLatencyNsNoFocus Filled with max latency while app is out of focus
//  -avgLatencyNsFocus Filled with avg latency while app is in focus
//  -avgLatencyNsNoFocus Filled with avg latency while app is out of focus
//========================================================================================================================================================================================================================
void getAPIMetrics(uint64_t* callCountsFocus, uint64_t* callCountsNoFocus, uint64_t* maxLatencyNsFocus,
                   uint64_t* maxLatencyNsNoFocus, uint64_t* avgLatencyNsFocus, uint64_t* avgLatencyNsNoFocus);
