//=======================================================================================================================================================================================================================
// FFmpeg-based x264 video decode
//======================================================================================================================================================================================================================= 
//  Example that shows how to use the libav parser system. This class forces a H264 parser and codec. 
//  You use it by opening a file that is encoded with x264 using the load() function. 
//  You can pass the framerate you want to use for playback. If you don't pass the framerate, we will detect it as soon as the parser found 
//  the correct information.
// 
//  After calling load(), you can call readFrame() which will read a new frame when necessary. It will also make sure that it will read enough data from the buffer/file
//  when there is not enough data in the buffer. readFrame() will trigger calls to the given h264_decoder_callback that you pass to the constructor. 
//=======================================================================================================================================================================================================================
#ifndef _h264_included_02347715146835610719567431560347856013784187364534534517
#define _h264_included_02347715146835610719567431560347856013784187364534534517
...
struct x264_decoder
{
    x264_decoder(h264_decoder_callback frameCallback, void* user);                         /* pass in a callback function that is called whenever we decoded a video frame, make sure to call `readFrame()` repeatedly */
    ~x264_decoder();                                                                       /* d'tor, cleans up the allocated objects and closes the codec context */
...
#endif // _h264_included_02347715146835610719567431560347856013784187364534534517