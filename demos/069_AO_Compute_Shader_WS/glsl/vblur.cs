...
layout (r32f, binding = 2) uniform image2D vblurred_image;
...
//==============================================================================================================================================================
// const int steps = 2;
// const float weights[steps] = {0.44908, 0.05092};
// const float offsets[steps] = {0.53805, 2.06278};

//==============================================================================================================================================================
// Kernel width 35 x 35
//==============================================================================================================================================================
const int steps = 9;
const float weights[steps] = {0.10855, 0.13135, 0.10406, 0.07216, 0.04380,  0.02328,  0.01083,  0.00441,  0.00157};
const float offsets[steps] = {0.66293, 2.47904, 4.46232, 6.44568, 8.42917, 10.41281, 12.39664, 14.38070, 16.36501};
...
void main()
{
    ...
    {                                                                                                                                                                
        uv_offset = offsets[s] * texel_size.zy;                                                                                                           
        q += weights[s] * (texture(data_in, uv_center + uv_offset).r + texture(data_in, uv_center - uv_offset).r);
    }                                                                                                                                                                

    imageStore(vblurred_image, ivec2(gl_GlobalInvocationID.xy), vec4(q, 0.0, 0.0, 0.0));
}