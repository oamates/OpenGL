...
int main(int argc, char *argv[])
{
    ...
    cubes_program["texture_sampler"] = 0;  
    glActiveTexture(GL_TEXTURE0);
    GLuint bunp_texture_id = image::png::texture2d("../../../resources/tex2d/bricks_bump.png");

    //===================================================================================================================================================================================================================
    // point data initialization 
    //===================================================================================================================================================================================================================
    const unsigned int CUBE_SIZE  = 0x20;
    const unsigned int POINT_COUNT = CUBE_SIZE * CUBE_SIZE * CUBE_SIZE;
    ...
    for (unsigned int k = 0; k < CUBE_SIZE; ++k)
    {
        ...
        point_data.push_back(glm::mat4(glm::vec4(axis_x, 0.0f),
                                       ...
                                       glm::vec4(3.0f * glm::vec3(2.0f * i - CUBE_SIZE + 1.0f, 2.0f * j - CUBE_SIZE + 1.0f, 2.0f * k - CUBE_SIZE + 1.0f), 1.0f)));
    ...
    // * DEPTH_TEST disabled
    // * Blending enabled, both rgb and alpha components of the framebuffer are modified on every pixel write
    //===================================================================================================================================================================================================================
    ...
    //===================================================================================================================================================================================================================
    glActiveTexture(GL_TEXTURE0);
    GLuint cube_texture_id = image::png::texture2d("../../../resources/tex2d/cube2.png");
