...
void main()
{
    ...
    vec4 normals[6]    = vec4[](frame[0], frame[1], frame[2],-frame[0],-frame[1],-frame[2]);
    vec4 tangents_x[6] = vec4[](frame[1], frame[2], frame[0], frame[2], frame[0], frame[1]);
    vec4 tangents_y[6] = vec4[](frame[2], frame[0], frame[1], frame[1], frame[2], frame[0]);
