//=======================================================================================================================================================================================================================
// STRIPE : newpolve.cpp
// This routine contains the bulk of the code that will find the patches of quads in the data model
//=======================================================================================================================================================================================================================
...
static int  added_quad = 0;
static bool reversed = false;
static int patch = 0;
extern int* vn;
extern int* vt;

static int Calculate_Walks(int lastvert,int y, PF_FACES temp2)
{
  /* Find the length of the walk */
  
    int previous_edge1, previous_edge2;
    int nextvert, numverts, counter, walk = 0;
    bool flag;
    F_EDGES* node;
    ListHead* pListHead;
    static int seen = 0;
...
static bool Check_Right(int last_seen,PF_FACES temp2,int y,int face_id)
{
...
static int Update_and_Test(PF_FACES temp2,int y,bool first,int distance,
...
static int Test_Adj(PF_FACES temp2,int x,int north,int distance,int lastvert, int value)
{
...
static int Find_Max(PF_FACES temp2,int lastvert,int north,int left,
...
static void Mark_Face(PF_FACES temp2, int color1, int color2,
...
static void Assign_Walk(int lastvert,PF_FACES temp2, int front_walk,int y,
            int back_walk)
{
...
static void Reset_Max(PF_FACES temp2,int face_id,int north,int last_north,
              int orientation,int last_left,FILE *output_file,
...
static int Peel_Max(PF_FACES temp2,int face_id,int north,int last_north, int orientation,
