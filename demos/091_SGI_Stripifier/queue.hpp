...
// priority : this is the priority of this structure in the List. The highest priority is 0.  This field is only used by the functions EnQue and DeQue.
//=======================================================================================================================================================================================================================

//=======================================================================================================================================================================================================================
// This is the general means of linking application defined information into
// Lists and queues.  All structures must begin with the Node Structure. All other data in the structure is user definable.
//=======================================================================================================================================================================================================================
...
//                  manipulation functions.  This must be the first element of a user definable structure.
//
//     In order for an application to use the List routines, it must define a structure with all the needed information.  The first element in the
//user definable structure must be a Node structure.  The Node structure contains all the necessary information for the List routines to do their magic. 
//For an example of a user defined List structure see the file ipd2i.h. The User definable structure can be passed to any List function that excepts a pointer to a ListInfo structure.
//
...
//               This information is used to point to the head and tail of a list.
// NumList    :  this integer hold the number of structures linked into this list.
//
// LISTHEAD  :  when Peeking down a list this specifies you should start at the head of the list and search downward.
// LISTTAIL  :  when Peeking down a list this specifies you should start at the tail of the list and search forward.
//=======================================================================================================================================================================================================================
...
//=======================================================================================================================================================================================================================
// InitList   : Initialize a new list structure for use with the List routines
// INPUTS     : LHead : a pointer to a ListHead structure.
// OUTPUT     : a boolean value TRUE if no errors occured FALSE otherwise
//=======================================================================================================================================================================================================================
bool InitList (PLISTHEAD);

//=======================================================================================================================================================================================================================
// PeekList   : This funciton peeks down a list for the N'th element from the HEAD or TAIL of the list
// INPUTS     : LHead    :  a pointer to a List head structure.
//              from     :  can either search from the HEAD or TAIL of the list
//              where    :  how many nodes from the begining should the List routines look.
// OUTPUT     : a pointer to a ListInfo structure identified by from / where or NULL if an error occurred.
//=======================================================================================================================================================================================================================
...
// INPUTS     : LHead : a pointer to a ListHead structure.
//              LInfo : a pointer to the ListInfo structure to remove from the list.
// OUTPUT     : a pointer to the ListInfo structure that was removed or NULL if an error occurred.
//=======================================================================================================================================================================================================================
...
// INPUTS     : LHead  : a pointer to a ListHead structure of the list to add to.
//              LInfo  : a pointer to the ListInfo structure to add to the list.
// OUTPUT     : A boolean value TRUE if no errors occurred FALSE otherwise.
//=======================================================================================================================================================================================================================
...
// INPUTS    : LHead  : a pointer to a ListHead structure of the List to remove from.
// OUTPUT    : a pointer to the ListInfo structure that was removed or NULL if an error occurred.
//=======================================================================================================================================================================================================================
...
//=======================================================================================================================================================================================================================
// SearchList : find a specific node in the queue whose key matches with searching key. 
// Input      : lpHashTbl       => a far pointer to the hash table
//              lpKey           => a far poniter to searching key
//              CompareCallBack => comparision function
// Output     : pointer to that node if found, return NULL otherwise
//=======================================================================================================================================================================================================================
