...
int main(int argc, char *argv[])
{
    ...
    //===================================================================================================================================================================================================================
    glsl_program_t fft8_img_h(glsl_shader_t(GL_COMPUTE_SHADER, "glsl/fft8_tb_h.cs"));
    fft8_img_h.enable();
    uniform_t uniform_ftt_time = fft8_img_h["time"];

    glsl_program_t fft8_img_v(glsl_shader_t(GL_COMPUTE_SHADER, "glsl/fft8_tb_v.cs"));
