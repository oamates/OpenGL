...
{
    u0 = imageLoad(inout_buffer, b + (0 << (m + m - 3))).rg;
    u1 = imageLoad(inout_buffer, b + (4 << (m + m - 3))).rg;
    u2 = imageLoad(inout_buffer, b + (2 << (m + m - 3))).rg;
    u3 = imageLoad(inout_buffer, b + (6 << (m + m - 3))).rg;
    u4 = imageLoad(inout_buffer, b + (1 << (m + m - 3))).rg;
    u5 = imageLoad(inout_buffer, b + (5 << (m + m - 3))).rg;
    u6 = imageLoad(inout_buffer, b + (3 << (m + m - 3))).rg;
    u7 = imageLoad(inout_buffer, b + (7 << (m + m - 3))).rg;    
...
void final_step8()
{
    ...
    v0 = u0 + u4; v1 = u1 + u5; v2 = u2 + u6; v3 = u3 + u7;
    v4 = u0 - u4; v5 = u1 - u5; v6 = u2 - u6; v7 = u3 - u7;
    ...
    imageStore(inout_buffer, b + (0 << (m + m - 3)), vec4(v0, 0.0, 0.0));
    imageStore(inout_buffer, b + (1 << (m + m - 3)), vec4(v1, 0.0, 0.0));
    imageStore(inout_buffer, b + (2 << (m + m - 3)), vec4(v2, 0.0, 0.0));
    imageStore(inout_buffer, b + (3 << (m + m - 3)), vec4(v3, 0.0, 0.0));
    imageStore(inout_buffer, b + (4 << (m + m - 3)), vec4(v4, 0.0, 0.0));
    imageStore(inout_buffer, b + (5 << (m + m - 3)), vec4(v5, 0.0, 0.0));
    imageStore(inout_buffer, b + (6 << (m + m - 3)), vec4(v6, 0.0, 0.0));
    imageStore(inout_buffer, b + (7 << (m + m - 3)), vec4(v7, 0.0, 0.0));    
}
