...
void main()
{
    vec2 wind = vec2(0.5 + 0.5 * cos(0.37 * time), 0.5 + 0.5 * sin(0.37 * time));
    ...
    //==========================================================================================================================================================
    // check that we are in the viewing frustum
    //==========================================================================================================================================================
    vec4 pv = projection_view_matrix * vec4(p, 1);
    ...
    //==========================================================================================================================================================
    vec3 b = hash_1(id) - vec3(0.5) + vec3(vec2(0.5), 0.0);
    ...
    // gravity lean
    //==========================================================================================================================================================
    float gravity_lean = 1.0845 * hash.x;  
    ...
    // initial blade width
    //==========================================================================================================================================================
    float s = clamp(pow(d + 0.317, 1.8), 0.25, 1.0);
    float w = 0.01 * hash.z * s;  
    float scale = 0.0505 * (0.2 + 0.8 * hash.z) * s;

    float y = 0.0;
    float z = floor(hash.z * 5.99);
    ...
    for (int i = 0; i < 8; ++i)
    {
        ...
        //======================================================================================================================================================
        w = 0.861 * w;
        p += scale * normalize(t + 0.77 * i * vnoise(p.xy - 10.0 * hash.xy) * (0.6 + 0.4 * cos(hash.z * time)) * vec3(wind, -4.0 * gravity_lean));
        t = t + gravity_lean * n;
        b = b - angular_twist * n;
        y += 0.125;
