...
//========================================================================================================================================================================================================================
// The shader does vertical FFT transform for a 2D n x n load 
//========================================================================================================================================================================================================================
...
{
    if (gl_WorkGroupSize.y == 4) return br4[q];
    if (gl_WorkGroupSize.y == 8) return br8[q];
    if (gl_WorkGroupSize.y == 16) return br16[q];
    if (gl_WorkGroupSize.y == 32) return br32[q];
    if (gl_WorkGroupSize.y == 64) return br64[q];
    if (gl_WorkGroupSize.y == 128) return br128[q];
    if (gl_WorkGroupSize.y == 256) return br256[q];
    return 0;
}
...
vec2 load(int index)
    { return imageLoad(inout_buffer, index).rg; }
...
//========================================================================================================================================================================================================================
// Routines processing 16 elements at once : 1xFFT16, 2xFFT8, 4xFFT4 or 8xFFT2
...
void iFFT16_x1()
{
    ...
    int b = (bit_reverse(iY) << m) + iX;

    u0 = load(b + (br16[0x0] << (m + m - 4))); u1 = load(b + (br16[0x1] << (m + m - 4)));
    u2 = load(b + (br16[0x2] << (m + m - 4))); u3 = load(b + (br16[0x3] << (m + m - 4)));
    u4 = load(b + (br16[0x4] << (m + m - 4))); u5 = load(b + (br16[0x5] << (m + m - 4)));
    u6 = load(b + (br16[0x6] << (m + m - 4))); u7 = load(b + (br16[0x7] << (m + m - 4)));
    u8 = load(b + (br16[0x8] << (m + m - 4))); u9 = load(b + (br16[0x9] << (m + m - 4)));
    uA = load(b + (br16[0xA] << (m + m - 4))); uB = load(b + (br16[0xB] << (m + m - 4)));
    uC = load(b + (br16[0xC] << (m + m - 4))); uD = load(b + (br16[0xD] << (m + m - 4)));
    uE = load(b + (br16[0xE] << (m + m - 4))); uF = load(b + (br16[0xF] << (m + m - 4)));
...
//========================================================================================================================================================================================================================
// Routines which processing 8 elements at once
// Should be used for n = 8 * local_size_x
//========================================================================================================================================================================================================================
...
void iFFT8_x1()
{
    ...
    u0 = load(b + (br8[0] << (m + m - 3))); u1 = load(b + (br8[1] << (m + m - 3)));
    u2 = load(b + (br8[2] << (m + m - 3))); u3 = load(b + (br8[3] << (m + m - 3)));
    u4 = load(b + (br8[4] << (m + m - 3))); u5 = load(b + (br8[5] << (m + m - 3)));
    u6 = load(b + (br8[6] << (m + m - 3))); u7 = load(b + (br8[7] << (m + m - 3)));
...
void iFFT4_x1()
{
    ...
    u0 = load(b + (br4[0] << (m + m - 2))); u1 = load(b + (br4[1] << (m + m - 2)));
    u2 = load(b + (br4[2] << (m + m - 2))); u3 = load(b + (br4[3] << (m + m - 2)));
...
void mFFT8_x1(int p2, float freq)
{
    ...
    Z[b + 0x0 * p2] = v0; Z[b + 0x1 * p2] = v1; Z[b + 0x2 * p2] = v2; Z[b + 0x3 * p2] = v3;
    Z[b + 0x4 * p2] = v4; Z[b + 0x5 * p2] = v5; Z[b + 0x6 * p2] = v6; Z[b + 0x7 * p2] = v7;        
}
...
void fFFT16_x1()
{
    ...
    u0 = Z[iY + (0x0 << (m - 4))]; u1 = Z[iY + (0x1 << (m - 4))]; u2 = Z[iY + (0x2 << (m - 4))]; u3 = Z[iY + (0x3 << (m - 4))]; 
    u4 = Z[iY + (0x4 << (m - 4))]; u5 = Z[iY + (0x5 << (m - 4))]; u6 = Z[iY + (0x6 << (m - 4))]; u7 = Z[iY + (0x7 << (m - 4))]; 
    u8 = Z[iY + (0x8 << (m - 4))]; u9 = Z[iY + (0x9 << (m - 4))]; uA = Z[iY + (0xA << (m - 4))]; uB = Z[iY + (0xB << (m - 4))]; 
    uC = Z[iY + (0xC << (m - 4))]; uD = Z[iY + (0xD << (m - 4))]; uE = Z[iY + (0xE << (m - 4))]; uF = Z[iY + (0xF << (m - 4))]; 
    ...
    if (((iY + iX) & 1) == 1)
    {
        ...
        u8 = -u8; u9 = -u9; uA = -uA; uB = -uB;
        uC = -uC; uD = -uD; uE = -uE; uF = -uF;
    }    

    store(b + (0x0 << (m + m - 4)), u0); store(b + (0x1 << (m + m - 4)), u1);
    store(b + (0x2 << (m + m - 4)), u2); store(b + (0x3 << (m + m - 4)), u3);
    store(b + (0x4 << (m + m - 4)), u4); store(b + (0x5 << (m + m - 4)), u5);
    store(b + (0x6 << (m + m - 4)), u6); store(b + (0x7 << (m + m - 4)), u7);
    store(b + (0x8 << (m + m - 4)), u8); store(b + (0x9 << (m + m - 4)), u9);
    store(b + (0xA << (m + m - 4)), uA); store(b + (0xB << (m + m - 4)), uB);
    store(b + (0xC << (m + m - 4)), uC); store(b + (0xD << (m + m - 4)), uD);
    store(b + (0xE << (m + m - 4)), uE); store(b + (0xF << (m + m - 4)), uF);                
}
...
void fFFT8_x2()
{
    ...
    store(b + (0x0 << (m + m - 4)), v0); store(b + (0x1 << (m + m - 4)), v1);
    store(b + (0x2 << (m + m - 4)), v2); store(b + (0x3 << (m + m - 4)), v3);
    store(b + (0x4 << (m + m - 4)), v4); store(b + (0x5 << (m + m - 4)), v5);
    store(b + (0x6 << (m + m - 4)), v6); store(b + (0x7 << (m + m - 4)), v7);
    store(b + (0x8 << (m + m - 4)), v8); store(b + (0x9 << (m + m - 4)), v9);
    store(b + (0xA << (m + m - 4)), vA); store(b + (0xB << (m + m - 4)), vB);
    store(b + (0xC << (m + m - 4)), vC); store(b + (0xD << (m + m - 4)), vD);
    store(b + (0xE << (m + m - 4)), vE); store(b + (0xF << (m + m - 4)), vF);                
}
...
void fFFT8_x1()
{
    ...
    u0 = Z[iY + (0 << (m - 3))]; u1 = Z[iY + (1 << (m - 3))]; u2 = Z[iY + (2 << (m - 3))]; u3 = Z[iY + (3 << (m - 3))];
    u4 = Z[iY + (4 << (m - 3))]; u5 = Z[iY + (5 << (m - 3))]; u6 = Z[iY + (6 << (m - 3))]; u7 = Z[iY + (7 << (m - 3))];
    ...
    store(b + (0x0 << (m + m - 3)), v0); store(b + (0x1 << (m + m - 3)), v1);
    store(b + (0x2 << (m + m - 3)), v2); store(b + (0x3 << (m + m - 3)), v3);
    store(b + (0x4 << (m + m - 3)), v4); store(b + (0x5 << (m + m - 3)), v5);
    store(b + (0x6 << (m + m - 3)), v6); store(b + (0x7 << (m + m - 3)), v7);      
...
void fFFT4_x1()
{
    ...
    u0 = Z[iY + (0 << (m - 2))]; u1 = Z[iY + (1 << (m - 2))]; u2 = Z[iY + (2 << (m - 2))]; u3 = Z[iY + (3 << (m - 2))];
    ...
    store(b + (0 << (m + m - 2)), u0); store(b + (1 << (m + m - 2)), u1);
    store(b + (2 << (m + m - 2)), u2); store(b + (3 << (m + m - 2)), u3);
}

void fFFT2_x1()
{
    vec2 w = iexp(highest_freq * iY); 
    barrier();     
