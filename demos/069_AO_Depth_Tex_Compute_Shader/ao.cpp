...
int main(int argc, char *argv[])
{
    ...
    //===================================================================================================================================================================================================================
    // framebuffer object with depth texture attached
    ...
    while (!window.should_close())
    {
        ...
        glCullFace(GL_BACK);
        glm::mat4 pvm_matrix = projection_view_matrix * demon_model_matrix;
        uni_gp_pvm_matrix = pvm_matrix;
        model.render();

        pvm_matrix = projection_view_matrix * room_model_matrix;
        uni_gp_pvm_matrix = pvm_matrix;
        glCullFace(GL_FRONT);
        cube_vao.render();
        ...
        //===============================================================================================================================================================================================================
        // 5. show UI and restore OpenGL setting
        //===============================================================================================================================================================================================================
        window.end_frame();
