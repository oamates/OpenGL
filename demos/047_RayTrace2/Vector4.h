...
namespace Dg
{
  ...
  {
    return sqrt(Matrix<1, 4, Real>::m_V[0] * Matrix<1, 4, Real>::m_V[0] + 
                Matrix<1, 4, Real>::m_V[1] * Matrix<1, 4, Real>::m_V[1] + 
                Matrix<1, 4, Real>::m_V[2] * Matrix<1, 4, Real>::m_V[2] + 
                Matrix<1, 4, Real>::m_V[3] * Matrix<1, 4, Real>::m_V[3]);
  ...
  {
    return (Matrix<1, 4, Real>::m_V[0] * Matrix<1, 4, Real>::m_V[0] + 
            Matrix<1, 4, Real>::m_V[1] * Matrix<1, 4, Real>::m_V[1] + 
            Matrix<1, 4, Real>::m_V[2] * Matrix<1, 4, Real>::m_V[2] + 
            Matrix<1, 4, Real>::m_V[3] * Matrix<1, 4, Real>::m_V[3]);
  ...
  void Vector4<Real>::Normalize()
  {
    ...
    {
      Matrix<1, 4, Real>::m_V[0] = static_cast<Real>(1.0);
      Matrix<1, 4, Real>::m_V[1] = static_cast<Real>(0.0);
      Matrix<1, 4, Real>::m_V[2] = static_cast<Real>(0.0);
      Matrix<1, 4, Real>::m_V[3] = static_cast<Real>(0.0);
    }
    else
    {
