...
//==============================================================================================================================================================
layout (binding = 0, offset = 0) uniform atomic_uint point_index;

//==============================================================================================================================================================
// output 3d texture, of size 2^{n} x 2^{n} x 2^{n}, n = max_level
//==============================================================================================================================================================
layout (r32ui, binding = 2) uniform uimage3D udf_tex;
...
{
    //==========================================================================================================================================================
    // get the index of the point this invocation will work on 
    //==========================================================================================================================================================
    uint p = atomicCounterIncrement(point_index);
    ...
    while (p < points)
    {
        ...
        //======================================================================================================================================================
        vec3 position = imageLoad(position_buffer, int(p)).xyz;
        ...
        while(l != 0)
        {
            ...
            float distance_to_node = length(node_position[l] - position);
            ...
            else
            {
                if (l == level - 1)
                {
                    ...
                    for(int v = 0; v < 8; ++v)
                    {
                        ...
                        float distance_to_leaf = length(leaf_position - position);
        ...
        //======================================================================================================================================================
        p = atomicCounterIncrement(point_index);
    }
}