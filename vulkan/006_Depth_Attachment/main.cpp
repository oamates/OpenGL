...
const std::string MODEL_PATH = "../../../resources/models/vao/pnt2/chalet/chalet.vao";
const std::string TEXTURE_PATH = "../../../resources/models/vao/pnt2/chalet/chalet.jpg";
...
struct GLFWVulkanApplication
{
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(res_x, res_y, "Vulkan Model Renderer", 0, 0);
        ...
        camera.infinite_perspective(constants::two_pi / 6.0f, float(res_x) / float(res_y), 0.1f);
    ...
    void initVulkan()
    {
        ...
        loadPNT2Model(MODEL_PATH.c_str());
        createUniformBuffer();
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("glsl/vert.spv");
        auto fragShaderCode = readFile("glsl/frag.spv");
    ...
    void loadPNT2Model(const char* file_name)
    {
        ...
        debug_msg("#vertices = %u", header.vbo_size);
        debug_msg("#indices = %u", header.ibo_size);


        //================================================================================================================================================================================================================
        // create vertex buffer
        //================================================================================================================================================================================================================
        VkDeviceSize bufferSize = stride * header.vbo_size;
        ...
        fread(data, stride, header.vbo_size, f);
        ...
        // create index buffer
        //================================================================================================================================================================================================================
        bufferSize = index_size * header.ibo_size;
        VDeleter<VkBuffer> stagingBuffer2{device, vkDestroyBuffer};
        VDeleter<VkDeviceMemory> stagingBufferMemory2{device, vkFreeMemory};
        createBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, 
            stagingBuffer2, stagingBufferMemory2);
        vkMapMemory(device, stagingBufferMemory2, 0, bufferSize, 0, &data);
        fread(data, index_size, header.ibo_size, f);
    ...
    void updateUniformBuffer()
    {
        ...
        ubo.projection_matrix = camera.projection_matrix;
        ubo.view_matrix = camera.view_matrix;
        ubo.model_matrix = glm::mat4(1.0f);
