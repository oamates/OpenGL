...
void main()
{
    ...
    sceneCol *= atten * min(sf + ao * 0.35, 1.0) * ao * (0.0625 + 0.6375 * sf);                              // shading + some ambient occlusion
