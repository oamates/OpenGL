#ifndef _H264_DECODER_included_093571620023565014789134515018460451716023685135
#define _H264_DECODER_included_093571620023565014789134515018460451716023685135

//	H264_Decoder
// -----------------------------------------------------------------------------------------------------------------------------------------------------------------
//	Example that shows how to use the libav parser system. This class forces a H264 parser and codec. You use it by opening a file that is encoded with x264 
// using the load() function. You can pass the framerate you want to use for playback. If you don't pass the framerate, we will detect it as soon as the parser found 
...
// readFrame() will trigger calls to the given h264_decoder_callback() that you pass to the constructor. 
// -----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#endif // _H264_DECODER_included_093571620023565014789134515018460451716023685135
