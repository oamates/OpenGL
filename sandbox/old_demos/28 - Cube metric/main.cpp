...
int main()
{
	...
	glm::vec4 light_ws[3] = 
	{
		glm::vec4(radius * glm::vec3(1.0f, 1.0f, 0.0f), 1.0f),
		glm::vec4(radius * glm::vec3(0.0f, 1.0f, 1.0f), 1.0f),
		glm::vec4(radius * glm::vec3(1.0f, 0.0f, 1.0f), 1.0f)
	};
