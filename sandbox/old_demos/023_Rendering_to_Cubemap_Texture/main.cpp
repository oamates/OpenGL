//========================================================================================================================================================================================================================
// DEMO 022: Rendering to cubemap texture
//========================================================================================================================================================================================================================
...
int main()
{
    ...
    //===================================================================================================================================================================================================================
    glfw_window window("Rendering to cubemap texture", 8, 3, 3, 1920, 1080);
    window.log_info();
	...
	glUniformMatrix4fv(cubes_program.uniform_id("projection_matrix"), 1, GL_FALSE, glm::value_ptr(camera.projection_matrix));		                	// set up projection matrix, it is not going to change
	...
	glUniformMatrix4fv(simple_light.uniform_id("projection_matrix"), 1, GL_FALSE, glm::value_ptr(camera.projection_matrix));		// set up projection matrix, it is not going to change
	...
	fbo_color_cubemap mirror_cubemap(TEXTURE_RESOLUTION);
	...
	while(!window.should_close())
    {
        ...
        glDrawElements(GL_POINTS, POINT_COUNT, GL_UNSIGNED_SHORT, 0);        
	   	...
	   	//===============================================================================================================================================================================================================
	    // rendering the central cube using created texture
		//===============================================================================================================================================================================================================
		...
		simple_light.enable();
		mirror_cubemap.bind_texture(GL_TEXTURE0);
        ...
        glDrawArrays(GL_TRIANGLES, 0, mesh_size);
   	    ...
   	    //===============================================================================================================================================================================================================
	    // rendering the scene to the screen framebuffer
	    //===============================================================================================================================================================================================================
