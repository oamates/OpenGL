...
int main()
{
	...
	GLuint point_light_color              = point_lighting.uniform_id("light_color");								                    // time uniform id

	// ==================================================================================================================================================================================================================
	// light settings
	// ==================================================================================================================================================================================================================

	glm::vec4 light_color[LIGHT_SOURCES] =
	{
	...
	glm::vec4 light_ws[LIGHT_SOURCES];
	float light_power[LIGHT_SOURCES] = {50.0f, 50.0f, 50.0f, 50.0f, 50.0f, 50.0f, 50.0f, 50.0f};
	float specular_power[LIGHT_SOURCES] = {20.0f, 20.0f, 20.0f, 20.0f, 20.0f, 20.0f, 20.0f, 20.0f};
    ...
    for (unsigned int i = 0; i < POINT_COUNT; ++i)
    {
        ...
        glm::vec3 color  = glm::normalize(glm::vec3(1.0f, 1.0f, 0.0f) + glm::sphericalRand(0.5f));
	...
	GLint uniform_light_ws          = simple_light.uniform_id("light_ws");
	GLint uniform_light_color       = simple_light.uniform_id("light_color");
	GLint uniform_light_power       = simple_light.uniform_id("light_power");
	GLint uniform_specular_power    = simple_light.uniform_id("specular_light_power");

    glUniformMatrix4fv(uniform_projection_matrix, 1, GL_FALSE, glm::value_ptr(projection_matrix));							// projection_matrix
	glUniform4fv(uniform_light_color, LIGHT_SOURCES, glm::value_ptr(light_color[0]));
	glUniform1fv(uniform_light_power, LIGHT_SOURCES, light_power);
	glUniform1fv(uniform_specular_power, LIGHT_SOURCES, specular_power);
	glUniform1i(simple_light.uniform_id("LIGHT_SOURCES"), LIGHT_SOURCES);
	...
	shadow_cubemap shadow(8, 1024);																		                    // 8 light sources, 2048 x 2048 cubemap resolution
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		float cs = cos(t);
		float sn = sin(t);
		light_ws[0] = glm::vec4(radius * glm::vec3(    cs,     sn,   1.0f), 1.0f);
		light_ws[1] = glm::vec4(radius * glm::vec3(  1.0f,     cs,     sn), 1.0f);
		light_ws[2] = glm::vec4(radius * glm::vec3(    sn,   1.0f,     cs), 1.0f);
		light_ws[3] = glm::vec4(radius * glm::vec3(    cs,     sn,  -1.0f), 1.0f);
		light_ws[4] = glm::vec4(radius * glm::vec3( -1.0f,     cs,     sn), 1.0f);
		light_ws[5] = glm::vec4(radius * glm::vec3(    sn,  -1.0f,     cs), 1.0f);
		light_ws[6] = glm::vec4(radius * glm::vec3(2 * sn,   0.0f, 2 * cs), 1.0f);
		light_ws[7] = glm::vec4(radius * glm::vec3(2 * cs, 2 * sn,   0.0f), 1.0f);


		// ==============================================================================================================================================================================================================
		// geometry render pass, create distance textures
		// ==============================================================================================================================================================================================================
		...
		shadow.bind();
	    glUniform4fv(shadow_light_ws, LIGHT_SOURCES, glm::value_ptr(light_ws[0]));
		...
		shadow.bind_texture(GL_TEXTURE2);
	    ...
	    glUniform4fv(uniform_light_ws, LIGHT_SOURCES, glm::value_ptr(light_ws[0]));
