...
template <class Matrix, class Vector, class Value> struct Attractor
{
	...
	Attractor(IAttractorUpdate<Matrix, Vector, Value>* attUpdate, const Vector& position) : _updateStrategy(attUpdate), _attModel(position) {};
