...
template <class Matrix, class Vector, class Value> struct CameraModel 
{
	...
	Vector getRotation() const
		{ return Vector(_pitch, _yaw, _roll); };
	...
	Value getAddPitch() const
		{ return _addPitch; };
	Value getAddYaw() const
		{ return _addYaw; };
	Value getAddRoll() const
		{ return _addRoll; };

	Value getAddXPos() const 
		{ return _addXPos; };
	Value getAddYPos() const 
		{ return _addYPos; };
	Value getAddZPos() const
		{ return _addZPos; };
