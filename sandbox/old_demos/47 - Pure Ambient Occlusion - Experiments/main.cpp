...
*/
	return v * (1.0f + 0.2f * glm::perlin(2.0f * v)) +
                       0.03089f * glm::vec3(glm::perlin(4.0f * v), glm::perlin(4.1f * v), glm::perlin(4.2f * v)) +
			           0.01312f * glm::vec3(glm::perlin(8.0f * v), glm::perlin(8.1f * v), glm::perlin(8.2f * v)) +
			           0.00745f * glm::vec3(glm::perlin(16.0f * v), glm::perlin(16.1f * v), glm::perlin(16.2f * v)) + 
			           0.00245f * glm::vec3(glm::perlin(32.0f * v), glm::perlin(32.1f * v), glm::perlin(32.2f * v));
...
int main()
{
	...
	glm::mat4 model_matrix = glm::scale(glm::vec3(250.0f, 250.0f, 250.0f));

	spherical_surface cave;
    cave.generate_vao(spherical_func, 8);
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		float t = glfwGetTime();
		glm::vec4 light_position = glm::vec4(180.0f * cos(t), 180.0f * sin(t), 0.0f, 1.0f);
